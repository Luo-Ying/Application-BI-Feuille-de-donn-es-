...
def scripts_individuel(connexion):
    ...
    # print(tabulate(df, headers='keys', tablefmt='psql'))
    # draw_box_plot(df, f'{colonne_1}', f'{colonne_1}', f"Boxplot des {colonne_1} avec échelle logarithmique", "Lots", True)
    # draw_hist_with_errors(df, f'{colonne_1}', f'Nb{colonne_1}', f"Distribution des {colonne_1}", "Lots", True)
    # draw_hist(df2, f'{colonne_1}', f'Nb{colonne_1}', f"Distribution des {colonne_1} avec échelle logarithmique", "Lots", True)
