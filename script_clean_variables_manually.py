...
# df_top1_contractS["awardPrice"] = (
#     df_top1_contractS["awardEstimatedPrice"]
#     if df_top1_contractS["awardEstimatedPrice"] is not None
#     else np.nan
# )

# # Modifying awardPrice based on awardEstimatedPrice for contractU
# df_top1_contractU["awardPrice"] = (
#     df_top1_contractU["awardEstimatedPrice"]
#     if df_top1_contractU["awardEstimatedPrice"] is not None
#     else np.nan
# )
...
#     cursor.execute(
#         "UPDATE Lots SET awardPrice = ? WHERE lotId = ?",
#         (str(row["awardPrice"]), row["lotId"]),
#     )
# conn.commit()
